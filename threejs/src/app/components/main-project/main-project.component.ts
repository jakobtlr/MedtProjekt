...
export class MainProjectComponent implements AfterViewInit {
  ...
  map!: Mesh;
  spotLight: SpotLight =  new THREE.SpotLight(0xffffff, 300);
  ...
  ngAfterViewInit(): void {
    ...
    this.spotLight.position.set(381, 175, 420);
    ...
    this.camera.position.set(380, 100, 430);
  ...
  loadPortal(): void {
    ...
    mtlLoader.load('assets/textures/Portal/Portal0000.mtl', (materials) => {
      materials.preload();
      const objLoader = new OBJLoader();
      objLoader.setMaterials(materials);
      objLoader.load('assets/textures/Portal/Portal0000.obj', (object) => {
